...
export function typeToId(deityType) {
...
export function idToType(domainId) {
...
export function makeCivData(curCiv, civInterface, population) {
	// Initialize Data
	var civData = [
	// Resources
	new Resource({ 
...
export function getWonderResources(civData) {
