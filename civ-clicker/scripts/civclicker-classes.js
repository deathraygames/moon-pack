...
/*
Exports:
	VersionData(major,minor,sub,mod) {
	CivObj(props, asProto)
	Resource(props)
	Building(props)
	Upgrade(props)
	Unit(props)
...
export function VersionData(major,minor,sub,mod) {
	this.major = major;
	this.minor = minor;
	this.sub = sub;
	this.mod = mod;
...
export function Resource(props) // props is an object containing the desired properties.
{
...
export function Building(props) // props is an object containing the desired properties.
{
...
export function Upgrade(props) // props is an object containing the desired properties.
{
...
export function Unit(props) // props is an object containing the desired properties.
{
...
export function Achievement(props) // props is an object containing the desired properties.
{
